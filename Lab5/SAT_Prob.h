...
namespace tribool
{
    ...
    inline bool_SAT AND(std::vector<bool_SAT> b) { return *std::min_element(b.begin(), b.end()); }
    inline bool_SAT OR (std::vector<bool_SAT> b) { return *std::max_element(b.begin(), b.end()); }
}
